...
class GameBot:
    def __init__(self, token):
        ...
        self.workers_gold = 0 # Количество рабочих на добыче золота
        self.workers_exp = 0 # Количество рабочих на добыче опыта
    ...
    async def profile(self, callback_query, user):
        await callback_query.message.answer(
            ...
            f"Свободные рабочие: {user.workers}\n"
            f"Рабочие на добыче золота: {self.workers_gold}\n"
            f"Рабочие на добыче опыта: {self.workers_exp}\n"
